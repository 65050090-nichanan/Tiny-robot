...
// ปกติ I2C ของ ESP32 ใช้ GPIO21/22 แต่ GPIO21 ของบอร์ดตัวนี้เสีย
// อาการ: ตอนไม่มีอะไรต่อจะอ่านได้ HIGH ปกติ แต่พอต่ออะไรก็ตามเข้าไปจะตกเป็น LOW ทันที
// ทดสอบแล้วเป็นทุกครั้งไม่ว่าจะเอาไปใช้เป็น SDA หรือ SCL ส่วนขาอื่นปกติดีหมด
// ถ้าเปลี่ยนบอร์ดใหม่ ย้ายกลับไป 21/22 ได้เลย
...
const uint32_t OLED_I2C_HZ = 100000;  // ส่งเข้าคอนสตรัคเตอร์ด้วย ไลบรารีจะได้ไม่ตั้ง 400 kHz เอง
